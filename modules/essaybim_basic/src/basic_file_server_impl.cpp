...
namespace EB
{
    ...
    std::string FileServerImpl::readFromFilePath(const std::string& filePath) const
    {
        std::string result;
    ...
    std::string FileServerImpl::openFile(const char* filter, HWND owner /*= nullptr*/) const
    {
        OPENFILENAMEA ofn;
        CHAR szFile[260] = { 0 };
    ...
    std::string FileServerImpl::saveFile(const char* filter, HWND owner /*= nullptr*/) const
    {
        OPENFILENAMEA ofn;
        CHAR szFile[260] = { 0 };
        ZeroMemory(&ofn, sizeof(OPENFILENAME));
