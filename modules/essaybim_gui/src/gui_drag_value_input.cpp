...
namespace EB
{
    ...
    DragValueInputF::DragValueInputF(const std::string& name, Vec2& value, const ValueInputWidget::ValueBoundary& boundary, const WidgetSlot& slot /*= nullptr*/)
        : ValueInputWidget(name, &value, 2, boundary, slot)
    {

    }

    DragValueInputF::DragValueInputF(const std::string& name, Vec3& value, const ValueInputWidget::ValueBoundary& boundary, const WidgetSlot& slot /*= nullptr*/)
        : ValueInputWidget(name, &value, 3, boundary, slot)
    {

    }

    DragValueInputF::DragValueInputF(const std::string& name, Vec4& value, const ValueInputWidget::ValueBoundary& boundary, const WidgetSlot& slot /*= nullptr*/)
