...
#define EB_ASSERT_GET_MARCO(...)                        \
    EB_EXPAND_MACRO(EB_ASSERT_GET_MACRO_NAME(__VA_ARGS__, EB_ASSERT_WITH_MSG, EB_ASSERT_WITHOUT_MSG))

#define EB_CORE_ASSERT(...)                             \
    EB_EXPAND_MACRO(EB_ASSERT_GET_MARCO(__VA_ARGS__)(CORE, __VA_ARGS__))
#define EB_CLIENT_ASSERT(...)                           \
    EB_EXPAND_MACRO(EB_ASSERT_GET_MARCO(__VA_ARGS__)(CLIENT, __VA_ARGS__))
#define EB_ASSERT(...)                                  \
    EB_EXPAND_MACRO(EB_CORE_ASSERT(__VA_ARGS__))